    ...
    var basicBot = {
        ...
        commands: {
            ...
            flamecommand: {
                ...
                rank: 'user',
                type: 'startsWith',
                getFlame: function (chat) {
                    // Big freaking list of insults
                    var flameList = ["Is your ass jealous of the amount of shit that just came out of your mouth?",
                    ...
                    var id = Math.floor((Math.random() * flameList.length) + 1); 
                    return flameList[id];
                },
                functionality: function (chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.cookie, {nameto: user.username, namefrom: chat.un, cookie: this.getFlame()}));
                            }
                        }
                    }
                }
            ...
            fbCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat(subChat(basicBot.chat.facebook, {link: "https://www.facebook.com/DragonTearsDj/"}));
                    }
                }
            },
